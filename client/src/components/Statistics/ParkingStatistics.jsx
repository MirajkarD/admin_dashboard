    ...
    return (
        <div className="p-4 space-y-4">
            ...
            <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg">
                ...
                <p>Current Occupancy: {occupancyRate.current}</p>
                <p>Peak Occupancy: {occupancyRate.peak}</p>
            </div>
            ...
            <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg">
                ...
                <p>Most Popular Slots: {usagePatterns.mostPopularSlots.join(', ')}</p>
            </div>
